...
- Fixed an issue where bottom sheet priming UI covered the entire screen when built using Xcode 26. 
...
[1.5.3]: https://github.com/phunware/artifact-permissions-ios/compare/1.5.2...1.5.3
[1.5.2]: https://github.com/phunware/artifact-permissions-ios/compare/1.5.1...1.5.2
